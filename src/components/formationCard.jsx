        ...
        <div className="formation-card" onClick={() => setExpanded(!expanded)}>
            ...
            {expanded && (
                <div className="formation-card-details">
                    <p><strong>Description:</strong> {formation.description || 'Aucune description disponible'}</p>
                    <p><strong>Durée:</strong> {formation.duration || 'Non spécifiée'}</p>
                    <p><strong>Débouchés:</strong> {formation.careers?.join(', ') || 'Non spécifiés'}</p>
