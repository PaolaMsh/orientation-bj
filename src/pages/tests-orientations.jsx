                ...
                <div className="to-hero-inner">
                    ...
                    {!loading && (
                        <div className="to-stats">
                            <span ><IconChart /> {stats.totalTests.toLocaleString()} tests déjà réalisés</span>
                            <span><IconClock /> Durée moyenne : {stats.avgTime} min</span>
                        </div>
                    )}
                </div>
            </div>
                ...
                <div className="to-cards">
                    <div className="to-card to-card--featured">
                        ...
                        <ul className="to-card-features">
                            <li><IconCheckCircle /> Profil détaillé sur 6 dimensions</li>
                            <li><IconCheckCircle /> Métiers et formations personnalisés</li>
                            <li><IconCheckCircle /> Rapport imprimable</li>
                        </ul>
                        <Link
                            to="/tests"
