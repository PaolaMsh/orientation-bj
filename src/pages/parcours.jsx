        ...
        async (assessment) => {
            ...
            try {
                ...
                try {
                    ...
                    const title =
                        assessment.type === 'PHASE1' ? 'Rapport Phase 1' : 'Rapport RIASEC';
                    ...
                    pdf.setFontSize(11);
                    pdf.text(
                        `Statut: ${STATUS_LABELS[assessment.status] || assessment.status}`,
                        20,
                        yPosition,
                    );
                    yPosition += 8;
                    ...
                    // Essayer de récupérer les recommandations pour le fallback
                    try {
                        ...
                        if (recos) {
                            ...
                            if (recos.careers && recos.careers.length > 0) {
                                ...
                                recos.careers.slice(0, 15).forEach((career) => {
                                    const name =
                                        typeof career === 'string' ? career : career.name || career;
                        ...
                        console.warn(
                            '⚠️ Impossible de récupérer les recommandations pour le fallback',
                        );
                    }
